      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4">
          <Button
            ...
            variant="outline"
            className="w-full h-auto p-6 items-center
                gap-4 border-2 transition-all duration-200 hover:border-primary
                hover:bg-primary/5"
          >
            <div
            ...
            <div className="text-left">
              ...
              <p>Post jobs and great talent</p>
            </div>
          </Button>
          ...
          >
            ...
            <div className="text-left">
              <h3 className="font-semibold text-lg">Job Seeeker</h3>
